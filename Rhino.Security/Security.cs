...
namespace Rhino.Security
{
    ...
    public class Security
    {
        ...
        /// <param name="entity">The entity.</param>
        /// <returns>
        /// If no IEntityInformationExtractor{TEntity} class is registered in the IoC container for
        /// the entity's runtime type this returns an empty Guid, otherwise the security key of the
        /// given entity.
        /// </returns>
        /// <remarks>
        /// It is recommended to use the ExtractKey{TEntity}(TEntity) method if possible as this code
        /// uses reflection to extract the entity security key.
        /// </remarks>
        internal static Guid ExtractKey(object entity)
        {
            ...
            {
                // If no IEntityInformationExtractor is registered then the entity isn't secured by
                // Rhino.Security. Ignore the error and return an empty Guid.
                return Guid.Empty;
            }
